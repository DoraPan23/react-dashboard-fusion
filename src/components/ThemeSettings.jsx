  ...
  return (
    <div className="bg-half-transparent w-screen fixed nav-item top-0 right-0">
      <div className="float-right h-screen dark:text-gray-200 bg-white dark:bg-main-dark-bg w-400">
        ...
        <div className="flex-col border-t-1 bordercolor p-4 ml-4">
          ...
          <div className="mt-4">
            ...
            />
            <label htmlFor="light" className="ml-2 text-md cursor-poiter">
              Light
            </label>
          </div>
          ...
          <div className="mt-4">
            ...
            />
            <label htmlFor="dark" className="ml-2 text-md cursor-poiter">
              Dark
            </label>
          </div>
        </div>
